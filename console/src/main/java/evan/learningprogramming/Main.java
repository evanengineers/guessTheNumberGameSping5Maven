...
//    private static final Logger log = LoggerFactory.getLogger(Main.class);  Commented this out after adding the SLF4J lombok annotation
    ...
    public static void main(String[] args) {
        ...
        //Now that this is spring boot application, we no longer need to open and close context. Added springboot annotation and now deleted this context opener and closer at the bottom
